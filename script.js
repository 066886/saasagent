...
const translations = {
    zh: {
        ...
        'benefits.results.chat.title': '真实配置对话示例',
        'benefits.results.chat.user': '"我需要设置API限流规则，每分钟最多100次请求"',
        'benefits.results.chat.ai': '"已为您配置完成！API限流已设置为100次/分钟，配置文件已更新。"',
    ...
    en: {
        ...
        'benefits.subtitle': 'Quick Integration, Immediate Results',
        ...
        'benefits.results.chat.title': 'Real Configuration Conversation Example',
        'benefits.results.chat.user': '"I need to set API rate limiting rules, maximum 100 requests per minute"',
        'benefits.results.chat.ai': '"Configuration completed! API rate limiting has been set to 100 requests/minute, configuration file updated."',
